...
from .views import ServiceList, ServiceDetails

# from .views import login_page,register_page

urlpatterns = [
    path('service/category/<slug>', ServiceList.as_view(), name='service-list-view-url'),
    path('service/detail/<slug>', ServiceDetails.as_view(), name='service-details-view-url'),
